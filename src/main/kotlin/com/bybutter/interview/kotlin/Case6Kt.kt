...
object Case6Kt : Case6 {
    /**
     * 解决 Bean 之间的依赖，并对 Bean 进行初始化。
     *
     * 传入的参数是一组未被初始化的 Bean，可以通过 Bean.dependencies
     ...
     * 初始化。
     *
     * 可以通过 Bean 的 initialized 属性来判断 Bean 是否已经调用过初始化
     * 方法。
     *
     ...
     */
    @Hard
    override fun dependentResolve(beans: List<Bean>): Boolean {
        TODO()
    }
}